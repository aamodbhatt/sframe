...
const expectedServiceWorkerCsp = parseCsp("default-src 'none'; script-src 'self'; connect-src http://app.localhost:4173/runtime/renderer/; worker-src 'none'; child-src 'none'; frame-src 'none'; object-src 'none'; base-uri 'none'; form-action 'none'; navigate-to 'none'; frame-ancestors 'none'");
