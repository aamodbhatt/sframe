...
| Shared rooms | Signed encrypted genesis, authenticated invitations, real SQLite Durable Object relay under Miniflare, concurrent offline edits, CAS sync, viewer persistence and durable missed-history warnings | Signed recovery, complete device forgetting and actor sequence validation |
